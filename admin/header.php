...
$modPathIcon16   = SERVICE_URL . '/' . $GLOBALS['xoopsModule']->getInfo('modicons16') . '/';
$modPathIcon32   = SERVICE_URL . '/' . $GLOBALS['xoopsModule']->getInfo('modicons32') . '/';
...
$style = SERVICE_URL . '/assets/css/admin/style.css';
