 ...
 * @return bool|null
 */
function xoops_module_update_service($module, $prev_version = null)
{
    $ret = null;
    if ($prev_version < 10) {
        $ret = update_service_v10($module);
    }

    $ret = service_check_db($module);

    //check upload directory
	include_once __DIR__ . '/install.php';
    $ret = xoops_module_install_service($module);
 ...
 * @return bool
 */
function update_service_v10($module)
{
    global $xoopsDB;
 ...
 * @return bool
 */
function service_check_db($module)
{
    $ret = true;
    ...
    $table   = $GLOBALS['xoopsDB']->prefix('service_images');
    $field   = 'img_exif';
