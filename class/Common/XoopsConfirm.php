...
namespace XoopsModules\Service\Common;
...
class XoopsConfirm
{
    ...
    public function getFormXoopsConfirm()
    {
        ...
        define('CO__SERVICE_DELETE_CONFIRM', 'Confirm delete');
        define('CO__SERVICE_DELETE_LABEL', 'Do you really want to delete:');
        ...
        if ('' === $this->title) {
            $this->title = CO__SERVICE_DELETE_CONFIRM;
        }
        if ('' === $this->label) {

            $this->label = CO__SERVICE_DELETE_LABEL;
        }
